...
class Tabs extends Component {
  ...
  state = {
    activeTab: this.props.activeTab !== null ? this.props.activeTab : 0,
  }
...
export class App extends Component {
  ...
  render() {
    return (
      <Tabs activeTab={this.state.activeTab} onChange={this.onTabChange}>
        <Tabs.List>
        ...
        <Tabs.Panels>
          ...
          <Tabs.Panel>
            Cakes are the reason why I'm writting React, so that I can afford
            them.
          </Tabs.Panel>
        </Tabs.Panels>
      </Tabs>
